class Cart {
    constructor() {
        ...
        this.billingDetails = JSON.parse(localStorage.getItem("billing_details") ||
            `{
        "name": "",
        "email": "",
        "address": "",
        ...
        this.checkoutModalEl =
            document.querySelector("div.checkout-modal");
        if (this.checkoutModalEl) {
            const rootEl = this.checkoutModalEl.querySelector("div.items-block");
            if (rootEl) {
                rootEl
                    .querySelectorAll("div.items-individual")
                ...
                for (const item of this.items) {
                    ...
                    itemEl.id = id;
                    {
                        ...
                        const deleteBlock = document.createElement("div");
                        {
                            ...
                            imgEl.setAttribute("data-w-id", "441548ba-3ca7-00a8-ee4c-2aefc08a226b");
    ...
    clear() {
        ...
        window.localStorage.setItem("billing_details", JSON.stringify(this.billingDetails));
        if (this.checkoutModalEl) {
            const itemEls = this.checkoutModalEl.querySelectorAll("div.items-individual");
    ...
    removeItem(id) {
        ...
        if (itemIndex !== -1) {
            ...
            if (this.checkoutModalEl) {
                const msgEl = this.checkoutModalEl.querySelector("div.cart-message");
                if (msgEl) {
